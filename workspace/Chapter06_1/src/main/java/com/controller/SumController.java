...
public class SumController {
	...
	/*
	 * @GetMapping(value="/result.do") public String result(@RequestParam
	 * Map<String, String> map, ModelMap modelMap) { modelMap.put("x",
	 * map.get("x")); modelMap.put("y", map.get("y")); return "/sum/result"; }
	 */
	
	@GetMapping(value="sum/result.do")
